export const en = {
  ...
  devDevices: {
    title: "Dev & Test Device Management",
    subtitle: "Manage developer device permissions (DevMode authorization) and sandbox testing allowlist",
    addBtn: "+ Register Device",
    refreshBtn: "Refresh",
    searchPlaceholder: "Search Device ID / Email / Notes...",
    deviceId: "Device ID (Fingerprint)",
    email: "Bound Email (Optional)",
    notes: "Notes",
    devModeSwitch: "DevMode Permission",
    devModeEnabled: "DevMode Granted",
    devModeDisabled: "DevMode Revoked",
    status: "Status",
    createdAt: "Registered At",
    actions: "Actions",
    edit: "Edit",
    delete: "Delete",
    deleteConfirm: "Are you sure you want to remove this device? It will lose DevMode access and sandbox testing qualifications.",
    toggleDevSuccess: "DevMode permission updated successfully",
    addModalTitle: "Register Dev / Test Device",
    editModalTitle: "Edit Device Information",
    deviceIdPlaceholder: "Enter 32-char hex Device ID (found in client About page)",
    emailPlaceholder: "e.g. dev@301098.xyz (optional)",
    notesPlaceholder: "e.g. Main MacBook Pro / Load test node (optional)",
    enableDevModeCheckbox: "Grant DevMode permission immediately (unlocks developer options during sync)",
    emptyHint: "No device records yet. Click '+ Register Device' to add one.",
    mintTestLicenseTip: "Test License Guide",
    mintTestLicenseDesc: "In sandbox mode, devices registered with both email and Device ID can be minted test licenses on the Licenses page."
  },
  common: {
    confirm: "Confirm",
    cancel: "Cancel",
  ...
  health: {
    ...
    probeTlsTitle: "LAN-TLS GTS CA Circuit Breaker",
    probeTlsDesc: "State: {state} · Successes: {success} · Failures: {failure}",
    probeTlsClosed: "Normal (CLOSED)",
    probeTlsHalfOpen: "Probing (HALF_OPEN)",
    probeTlsOpen: "Tripped (OPEN)"
  },
  audit: {
    actions: {
      ALL: "All Actions",
  ...
  tls: {
    ...
    backupCircuitStatus: "Backup CA Circuit (Let's Encrypt)",
    primaryCaTitle: "Primary (GTS)",
    backupCaTitle: "Backup (Let's Encrypt)",
    resetBtn: "⚡ Break-Glass Reset",
    autoRefreshTitle: "Automatically refresh every 30 seconds",
    totalAttemptsSub: "Total initiated in past 24 hours",
    avgDurationSub: "RFC 8555 closed-loop average latency",
    attributionHint: "Precise attribution based on error audits",
    ...
    nodeIdInvalid: "Node ID must be a 12-character hex string (e.g. bb0000000001)",
    ipLabel: "Client IP Address",
    ipPlaceholder: "Enter IPv4 / IPv6 address",
    ipRequired: "Client IP address is required",
