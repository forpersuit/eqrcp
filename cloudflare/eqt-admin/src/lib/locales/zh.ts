export const zh = {
  ...
  devDevices: {
    title: "开发与测试设备管理",
    subtitle: "统一管理开发者设备权限 (Dev 模式授权) 与沙箱测试设备白名单",
    addBtn: "+ 录入新设备",
    refreshBtn: "刷新列表",
    searchPlaceholder: "搜索 Device ID / 邮箱 / 备注...",
    deviceId: "Device ID (设备指纹)",
    email: "绑定邮箱 (选填)",
    notes: "备注说明",
    devModeSwitch: "Dev 模式权限",
    devModeEnabled: "已授权 Dev 模式",
    devModeDisabled: "未授权 Dev 模式",
    status: "状态",
    createdAt: "录入时间",
    actions: "操作",
    edit: "编辑",
    delete: "删除",
    deleteConfirm: "确定要从白名单中删除该设备记录吗？删除后该设备将失去 Dev 模式授权与沙箱测试资格。",
    toggleDevSuccess: "Dev 模式权限已更新",
    addModalTitle: "录入开发 / 测试设备",
    editModalTitle: "编辑设备信息",
    deviceIdPlaceholder: "请输入 32 位 hex 设备 ID (可在客户端关于页面底部查看)",
    emailPlaceholder: "例如 dev@301098.xyz (选填)",
    notesPlaceholder: "例如: 张三的开发机 / 压测节点 (选填)",
    enableDevModeCheckbox: "直接开通 Dev 模式权限 (客户端对账时解锁开发者选项)",
    emptyHint: "暂无录入的设备记录。点击右上角「+ 录入新设备」开始添加。",
    mintTestLicenseTip: "发码快捷指引",
    mintTestLicenseDesc: "沙箱环境下，录入包含有效邮箱与 Device ID 的记录后，可直接在授权码管理页面签发测试资格码。"
  },
  common: {
    confirm: "确认",
    cancel: "取消",
  ...
  health: {
    ...
    probeTlsTitle: "LAN-TLS GTS CA 断路器",
    probeTlsDesc: "状态: {state} · 连续成功: {success} · 连续失败: {failure}",
    probeTlsClosed: "正常 (CLOSED)",
    probeTlsHalfOpen: "试探 (HALF_OPEN)",
    probeTlsOpen: "熔断 (OPEN)"
  },
  audit: {
    actions: {
      ALL: "全部动作",
  ...
  tls: {
    ...
    failoverEvents: "灾备自动转移",
    backupCircuitStatus: "备用 CA 断路器 (Let's Encrypt)",
    primaryCaTitle: "主力 GTS CA",
    backupCaTitle: "灾备 Let's Encrypt",
    resetBtn: "⚡ 运维解封 (Break-Glass)",
    autoRefreshTitle: "每 30 秒自动刷新",
    totalAttemptsSub: "近 24 小时总发起",
    avgDurationSub: "RFC 8555 闭环平均时延",
    attributionHint: "根据系统错误审计精准归因，杜绝误判",
    ...
    nodeIdRequired: "请输入节点标识 (Node ID)",
    nodeIdInvalid: "Node ID 必须为 12 位十六进制字符串 (如 bb0000000001)",
    ipLabel: "客户端 IP 地址",
    ipPlaceholder: "请输入客户端 IPv4 / IPv6 地址",
    ipRequired: "请输入客户端 IP 地址",
    ipInvalid: "请输入合法的 IPv4 或 IPv6 地址",
    confirmTarget: "目标",
    confirmKey: "键值",
