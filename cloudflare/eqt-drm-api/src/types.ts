export interface Env {
  ...
  /** Paddle Price IDs (Standard names) */
  PADDLE_PRICE_ID_PLUS_YEARLY?: string;
  PADDLE_PRICE_ID_PLUS_LIFETIME?: string;
...
// Default Price IDs for Live vs Sandbox environments
export const PROD_PRICE_LIFETIME_ID = "pri_01kyd2nbsmg44rjmvf4vbetgwj";
export const PROD_PRICE_YEARLY_ID = "pri_01kydyzmn1pc29npe377dxtq96";
export const SANDBOX_PRICE_LIFETIME_ID = "pri_01kyhmkv4ppj10r4cdgw3sv48p";
export const SANDBOX_PRICE_YEARLY_ID = "pri_01kxymxqngex49tg65wb0701pc";

// Backward-compatible fallback exports (deprecated, use environment variables or explicit environment constants)
export const PRICE_LIFETIME_ID = PROD_PRICE_LIFETIME_ID;
export const PRICE_YEARLY_ID = PROD_PRICE_YEARLY_ID;
