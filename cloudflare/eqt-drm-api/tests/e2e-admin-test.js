...
function makeRequest(path, method = 'GET', headers = {}, body = null) {
  return new Promise((resolve, reject) => {
    ...
    req.setTimeout(10000, () => {
      req.destroy(new Error(`Timeout connecting to ${method} ${path}`));
    });
...
async function runAdminTestSuite() {
  ...
  try {
    ...
    console.log("✓ License search successfully returned created license with activations array.");
    ...
    console.log("\n==================================================");
    console.log("🎉🎉 ALL ADMIN API CONTRACT TESTS PASSED! 🎉🎉");
    console.log("==================================================");

  } catch (err) {
    console.error("\n❌ ADMIN E2E TEST FAILED:", err);
    process.exit(1);
  }
}
