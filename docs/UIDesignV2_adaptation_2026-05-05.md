...
Phase 1 is a structural and visual adaptation. It intentionally avoids protocol
changes such as real upload progress, delivery receipts, or online presence.
...
- True device count and device list presence.
...
- Add device presence and delivery acknowledgements only after the state model
  can represent them accurately.
