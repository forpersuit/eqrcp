...
| **Pro (月度版 - 预留架构/暂未开放)** | 跨公网（WAN）P2P 聊天与大文件传输 | 月度订阅制 | $2.99/月 | 必须联网，云端信令服务鉴权与打洞节点校验（预留 Tier 架构设计，暂未开放购买）。 |
| **Pro (年度版 - 预留架构/暂未开放)** | 跨公网（WAN）P2P 聊天与大文件传输 | 年度订阅制 | $29.99/年 | 必须联网，云端信令服务鉴权与打洞节点校验（预留 Tier 架构设计，暂未开放购买）。 |

> **说明**：Pro 套餐（公网 WAN 穿透版）目前仅在 Tier 架构与设计规范中进行了预留与规划（包括 $2.99/月 的月度订阅与 $29.99/年的年度订阅），暂未开放线上购买与公网服务器中继接入逻辑；当前已开放售卖与核心实现的为 Plus 局域网解限套餐。
