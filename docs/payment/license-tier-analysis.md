...
| **Chat (聊天)** | - 无时间限制<br>- 独享满速 Chat 体验 | - 每日免费额度为 **5分钟 (300秒)**（仅 **remote peer** 在线时计时，Host-only 不计）<br>- 超额后**不掐断**会话：附件 **100KB/s**、单文件 **≤2MB**；文本照常<br>- **无**随机消息失败 | Chat V2：`HasRemoteClient` + `IncrementUsage`；附件数据面 `PolicyFreeDegraded`。详见 [`docs/chat/free-tier-usage-analysis.md`](../chat/free-tier-usage-analysis.md)。 |
