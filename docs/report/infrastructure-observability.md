...
| # | 事项 | 状态 | 负责人 | 预计完成 | 实际完成 | 验证方式 |
|---|---|---|---|---|---|---|
| 9 | 请求级 trace_id（Worker + D1 + 桌面端） | ⬜ 待开始 | — | — | — | 响应含 X-Trace-Id，D1 可查 |
| 10 | 业务指标仪表盘（admin 页面） | ⬜ 待开始 | — | — | — | 5 个指标可查看，与 D1 查询一致 |
| 11 | 告警升级机制（Telegram + 邮件分层） | ⬜ 待开始 | — | — | — | CRITICAL 触发 1 分钟内 Telegram 通知 |
