...
Write-Host "  2. Run Go tests (go test ./...)"
Write-Host "  3. Build GUI frontend (npm run build)"
Write-Host "  4. Run GUI Go tests"
Write-Host "  5. Rebuild executables to E:/developer/results"
Write-Host "  6. Continue with the commit"
Write-Host ""
