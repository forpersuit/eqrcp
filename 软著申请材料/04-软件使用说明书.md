# EQT Easy QR Transfer 局域网文件传输系统 软件使用说明书
...
#### 2.1.1 下载安装
1. 下载`eqrcp.exe`与`eqrcp-launcher.exe`可执行文件。
...
![图3.1 命令行运行发送文件命令并显示二维码](images/01_send_qr.png)
...
![图3.2 移动设备浏览器端文件上传界面](images/02_receive_web.png)
...
![图3.3 局域网内多设备实时聊天页面](images/03_chat_room.png)
...
![图5.1 EQT 桌面客户端主界面](images/05_desktop_gui.png)
...
![图5.2 系统托盘快捷菜单](images/06_tray_menu.png)
...
![图5.3 桌面客户端设置面板](images/07_gui_settings.png)
...
![图6.1 Windows系统右键菜单与桌面分享弹窗](images/04_desktop_share.png)
